  ...
  return (
    ...
    >
      {NAV_GROUPS.map((group) => {
        // Services are public marketing/policy pages (eKYC included) —
        // reached from the public website's own Services menu, not from
        // either dashboard's operations rail.
        if (group === "Services") return null;
